<nav class="navbar navbar-expand-lg bg-pink" data-bs-theme="pink" style="background-color: #ffcccb;">
   ...
   <a class="navbar-brand" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbarColor03">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{route('carrito')}}"><i class="fa fa-shopping-cart fa-2x" style="font-size: 18px;"></i></a>  
        </li>
      <li>
